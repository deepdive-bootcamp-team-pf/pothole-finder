...
import { logInController, getProfileByProfileUsername } from './log-in.controller'
...
logInRoute.route('/:profileEmail')
    .get(asyncValidatorController([check('profileUsername', 'Test message')]), getProfileByProfileUsername)