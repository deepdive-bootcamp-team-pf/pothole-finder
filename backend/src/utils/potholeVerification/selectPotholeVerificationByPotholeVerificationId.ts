...
export async function selectPotholeVerificationByPotholeVerificationId(potholeVerification: PotholeVerification) : Promise<PotholeVerification|null> {
    ...
    const mysqlQuery = 'SELECT BIN_TO_UUID(potholeVerificationPotholeId) AS potholeVerificationPotholeId, BIN_TO_UUID(potholeVerificationProfileId) AS potholeVerificationProfileId, potholeVerificationDate FROM potholeVerification WHERE potholeVerificationPotholeId = UUID_TO_BIN(:potholeVerificationPotholeId) AND potholeVerificationProfileId = UUID_TO_BIN(:potholeVerificationProfileId)'
