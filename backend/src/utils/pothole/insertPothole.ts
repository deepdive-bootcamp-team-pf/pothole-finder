...
export async function insertPothole(pothole: Pothole) : Promise<string> {
    ...
    const mysqlQuery = 'insert into pothole(potholeId, potholeProfileId,  potholeDate, potholeDescription, potholeLng, potholeLat, potholeSeverity) values (UUID_TO_BIN(UUID()))'
