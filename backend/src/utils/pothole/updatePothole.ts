...
export async function updatePothole(pothole: Pothole) : Promise<string> {
    ...
    const mysqlQuery = 'update pothole set potholeDescription = :potholeDescription, potholeLng = :potholeLng, potholeLat = :potholeLat, potholeSeverity = :potholeSeverity where potholeId = UUID_TO_BIN(:potholeId)'
