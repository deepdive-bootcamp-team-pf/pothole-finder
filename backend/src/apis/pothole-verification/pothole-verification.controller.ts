...
export async function getAllPotholeVerificationController(
  request: Request,
  response: Response
): Promise<Response> {
  try {
...
export async function getPotholeVerificationByPotholeVerificationProfileIdController(
  request: Request,
  response: Response
): Promise<Response> {
  try {
    const { potholeVerificationProfileId } = request.params;
    const data = await selectPotholeVerificationsByPotholeVerificationProfileId(
...
export async function getPotholeVerificationByPotholeVerificationPotholeIdController(
  request: Request,
  response: Response
): Promise<Response> {
  try {
    const { potholeVerificationPotholeId } = request.params;
    const data = await selectPotholeVerificationsByPotholeVerificationPotholeId(
...
export async function togglePotholeVerificationController(
  request: Request,
  response: Response
  ...
  try {
    ...
    const selectedPotholeVerification: PotholeVerification | null =
      await selectPotholeVerificationByPotholeVerificationId(
        potholeVerification
      );
