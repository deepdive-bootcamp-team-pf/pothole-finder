...
potholeVerificationRoute
  .route("/")
  .get(getAllPotholeVerificationController)
  .post(
    isLoggedIn,
    asyncValidatorController(checkSchema(potholeVerificationValidator)),
    togglePotholeVerificationController
  );

potholeVerificationRoute
  .route("/PVProf/:potholeVerificationProfileId")
  .get(
    asyncValidatorController([
      check(
        "potholeVerificationProfileId",
        "Enter a valid profile ID for the pothole verifications."
      ).isUUID(),
    ]),
    getPotholeVerificationByPotholeVerificationProfileIdController
  );
...
potholeVerificationRoute
  .route("/PVPot/:potholeVerificationPotholeId")
  .get(
    asyncValidatorController([
      check(
        "potholeVerificationPotholeId",
        "Enter a valid pothole ID for the pothole verifications."
      ).isUUID(),
    ]),
    getPotholeVerificationByPotholeVerificationPotholeIdController
  );
