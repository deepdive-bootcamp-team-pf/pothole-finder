        ...
        >
            ...
            <Modal.Body>
                <Container fluid className={"pt-3 background-image"}>
                    <p className={'m-0 ps-3 text-white text-on-photo'}>Signing up is free and easy.</p>
                    <p className={'mt-0 mx-0 mb-5 ps-3 text-white text-on-photo'}>Members can post potholes instantly!</p>
                </Container>
                <SignUpForm/>
            </Modal.Body>
        </Modal>
